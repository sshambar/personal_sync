...
(custom-theme-set-faces
 ...
 '(cperl-array-face ((t (:foreground "LawnGreen" :background "black"))))
 '(cperl-hash-face ((t (:foreground "SpringGreen" :background "black"))))
 '(cperl-nonoverridable-face ((t (:foreground "chartreuse3"))))
 '(gnus-button ((t (:weight bold :background "blue2" :box (:line-width 2 :style released-button)))))
 ...
 '(erc-header-line ((t (:background "grey95" :foreground "black"))))
 ...
 '(button ((t (:background "blue2" :foreground "white" :box (:line-width 2 :color "grey75" :style released-button) :underline t))))
 '(calendar-today-face ((t (:underline t :foreground "cornsilk"))))
 '(change-log-acknowledgement-face ((t (:slant oblique :foreground "AntiqueWhite3"))))
 ...
 '(change-log-file-face ((t (:family "Verdana" :weight bold :foreground "LightSkyBlue" :height 0.9))))
 ...
 '(custom-button ((t (:background "lightgrey" :foreground "black" :box (quote (:line-width 2 :style released-button))))))
 '(custom-button-pressed ((t (:background "lightgrey" :foreground "black" :box (quote (:line-width 2 :style pressed-button))))))
 '(custom-changed ((t (:foreground "wheat" :background "blue"))))
 '(custom-comment ((t (:background "dim gray"))))
 '(custom-comment-tag ((t (:foreground "gray80"))))
 '(custom-face-tag ((t (:family "helv" :weight bold :height 1.1))))
 '(custom-group-tag ((t (:family "helv" :foreground "light blue" :weight bold :height 1.1))))
 '(custom-group-tag-1 ((t (:family "helv" :foreground "pink" :weight bold :height 1.1))))
 ...
 '(custom-variable-button ((t (:underline t :weight bold :background "lightgrey" :foreground "black" :box (quote (:line-width 2 :style released-button))))))
 '(custom-variable-tag ((t (:family "helv" :foreground "light blue" :weight bold :height 1.2))))
 ...
 '(eshell-test-failed-face ((t (:foreground "OrangeRed"))))
 '(eshell-test-ok-face ((t (:foreground "Green"))))
 '(file-name-shadow ((t (:foreground "grey70"))))
 '(fixed-pitch ((t (:family "courier"))))
 '(flyspell-duplicate-face ((t (:foreground "IndianRed" :underline t))))
 '(flyspell-incorrect-face ((t (:foreground "Pink" :underline t))))
 ...
 '(js2-error-face ((t (:background "indian red" :foreground "green"))))
 ...
 '(mode-line-inactive ((t (:inherit default :background "grey30" :foreground "grey80" :box (quote (:line-width -1 :color "grey40")) :weight light :height 0.9))))
 ...
 '(vhdl-font-lock-reserved-words-face ((t (:foreground "Orange"))))
